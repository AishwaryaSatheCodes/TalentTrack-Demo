  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, i) => (
          <div
            className="backdrop-blur-lg bg-gray-700/5 shadow-lg flex items-center justify-center p-4 text-xl  text-center border-[1px] border-violet-100 rounded-[15px] select-none box-border relative"
            key={i}
            style={{
